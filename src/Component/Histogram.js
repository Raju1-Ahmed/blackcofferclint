...
const Histogram = (props) => {
	...
	let jsonURL = "https://blackcoffersever.onrender.com/allinfo";
	...
	const getURLData = async () => {
		...
		jsonResult.forEach((element) => {
			if (stateFreq[element.country] > 0) {
				stateFreq[element.country] = stateFreq[element.country] + 1;
			} else {
				stateFreq[element.country] = 1;
			}
		})
